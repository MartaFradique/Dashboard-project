            ...
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  ...
                  <span className='p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-ehite bg-green-400 ml-3 text-xs'>23%</span>
                </p>
                <p className='text-gray-600 mt-1'>Budjet</p>
              </div>
              <div className='mt-8'>
                <p>
